...
const Blog = () => {
    ...
    //     const getAllBlogs = () => {
    //         axios.get(' https://confused-lime-moccasins.cyclic.cloud/getblogs', { timeout: 10000 })
    //             .then((res) => {
    ...
    useEffect(() => {
        ...
        const getAllBlogs = async () => {
            try {
                const response = await axios.get('https://confused-lime-moccasins.cyclic.cloud/getblogs');
